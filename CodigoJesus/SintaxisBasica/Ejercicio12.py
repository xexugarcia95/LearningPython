...
payaso = int(input("Introduce el numero de payasos: "))
muneca = int(input("Introduce el numero de muñecas: "))
peso = (payaso*112)+(muneca*75)
print("El paquete pesa " + str(peso) + " gramos.")
